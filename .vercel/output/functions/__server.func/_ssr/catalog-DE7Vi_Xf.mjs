//#region node_modules/.nitro/vite/services/ssr/assets/catalog-DE7Vi_Xf.js
var CATEGORIES = [
	{
		slug: "electronique",
		name: "Électronique",
		blurb: "Smartphones, audio et recharge"
	},
	{
		slug: "mode",
		name: "Mode",
		navLabel: "Mode & Accessoires",
		blurb: "Style & élégance au quotidien"
	},
	{
		slug: "accessoires",
		name: "Accessoires",
		blurb: "Sacs, montres et coques"
	},
	{
		slug: "maison",
		name: "Maison",
		navLabel: "Maison & Lifestyle",
		blurb: "Confort et décoration"
	},
	{
		slug: "beaute",
		name: "Beauté & Santé",
		blurb: "Parfums, soins et bien-être"
	},
	{
		slug: "sport",
		name: "Sport & Loisirs",
		blurb: "Baskets et équipement"
	},
	{
		slug: "high-tech",
		name: "High-Tech",
		blurb: "Tablettes, montres et PC"
	},
	{
		slug: "autres",
		name: "Autres",
		blurb: "Le reste de la sélection"
	}
];
var NAV_LINKS = [
	{
...
var PRODUCTS = [
	{
		...
		longDescription: "Profitez d'un son riche et d'un maintien confortable toute la journée. Boîtier compact, connexion Bluetooth instantanée et commandes tactiles. Idéal pour les appels, la musique et vos déplacements en ville.",
		specs: [
			{
				icon: "battery",
				label: "Autonomie 28 h avec étui"
			},
			{
				icon: "generic",
				label: "Bluetooth 5.3"
	...
	},
	{
		...
		longDescription: "Une smartwatch complète pour le sport et le quotidien : rythme cardiaque, oxymétrie, nombreuses cadrans et étanchéité pour la pluie. Synchronisation avec Android et iOS.",
		specs: [
			{
				icon: "screen",
				label: "Écran AMOLED 1.8\""
			},
			{
				icon: "battery",
				label: "Autonomie 7 jours"
			},
			{
				icon: "generic",
				label: "GPS + cardio"
	...
	},
	{
		...
		longDescription: "Conçues pour marcher longtemps sans effort. Mesh respirant, semelle amortie et silhouette contemporaine qui s'accorde avec tout.",
		colors: [{
			id: "noir",
			name: "Noir",
			hex: "#161616"
	...
	},
	{
		...
		longDescription: "Coupe flatteuse, tissu fluide et couleur profonde. Parfaite pour un dîner, un événement ou un look de bureau raffiné.",
		colors: [{
			id: "rouge",
			name: "Rouge",
			hex: "#9b1c2c"
	...
	},
	{
		...
		longDescription: "Poche laptop 15,6\", compartiments organisés et bretelles rembourrées. Résistant à la pluie légère, idéal campus, bureau et voyage.",
		colors: [{
			id: "noir",
			name: "Noir",
			hex: "#1a1a1a"
	...
	},
	{
		...
		longDescription: "GaN compact 65 W, compatible USB-C PD. Rechargez votre smartphone en un temps record, sans surchauffe.",
		stock: 80
	},
	{
		id: "p-headphones",
		...
		longDescription: "Coussinets moelleux, réduction de bruit passive et autonomie de 30 heures. Le compagnon idéal des trajets et du télétravail.",
		colors: [{
			id: "noir",
			name: "Noir",
			hex: "#111111"
	...
	},
	{
		...
		longDescription: "Un basique haut de gamme qui garde sa forme au lavage. Doux, respirant, à porter seul ou sous une veste.",
		colors: [
			{
				id: "beige",
				name: "Beige",
	...
	},
	{
		...
		longDescription: "Écran Full HD, 8 Go de RAM, 128 Go de stockage et batterie longue durée. Parfaite pour Netflix, la bureautique et la lecture.",
		specs: [
			{
				icon: "screen",
				label: "Écran 10\" Full HD"
			},
			{
				icon: "storage",
				label: "128 Go"
	...
	},
	{
		...
		longDescription: "Des notes de bergamote, bois de cèdre et vanille. Un parfum distingué pour le jour comme pour le soir, en flacon cadeau.",
		stock: 45
	},
	{
		id: "p-watch-woman",
		...
		longDescription: "Élégante et légère, elle suit vos pas, votre sommeil et vos notifications. Plusieurs bracelets interchangeables.",
		colors: [{
			id: "or-rose",
			name: "Or rose",
			hex: "#d4a574"
	...
	},
	{
		...
		featured: true,
		bestSeller: true,
		description: "Un smartphone puissant et élégant, conçu pour vous offrir une expérience fluide et immersive. Idéal pour le travail, le divertissement et la créativité.",
		longDescription: "Processeur 5G dernière génération, écran AMOLED 120 Hz, triple capteur photo 50 MP et batterie 5000 mAh avec charge rapide. Un téléphone pensé pour durer, avec des finitions premium et une interface fluide au quotidien.",
		specs: [
			{
				icon: "screen",
				label: "Écran 6.7\" AMOLED"
			},
			{
				icon: "storage",
				label: "128 Go de stockage"
			},
			{
				icon: "camera",
				label: "Caméra 50 MP"
	...
	},
	{
		...
		longDescription: "Protège votre smartphone des chocs du quotidien tout en restant élégante et légère. Accès intégral aux boutons et ports.",
		colors: [{
			id: "noir",
			name: "Noir",
			hex: "#1a1a1a"
	...
	},
	{
		...
		longDescription: "Léger, silencieux, autonomie d'une journée. Parfait pour les professionnels, étudiants et créateurs nomades.",
		specs: [
			{
				icon: "screen",
				label: "Écran 14\" Full HD"
			},
			{
				icon: "storage",
				label: "SSD 512 Go"
...
var PRODUCT_REVIEWS = { "p-smartphone": [
	{
		id: "r1",
		author: "Fatou B.",
		city: "Ouagadougou",
...
var PROMO_CODES = {
	...
	WELCOME: {
		type: "percent",
		value: 15,
		label: "15 % de bienvenue"
	},
	AFRICA: {
		type: "fixed",
		value: 5e3,
		label: "5 000 FCFA de remise"
	}
};
var SHIPPING_FEE = 5e3;
var WHATSAPP_NUMBER = "22670000000";
var WHATSAPP_TEXT = encodeURIComponent("Bonjour Digital Business Store, j'ai une question concernant une commande.");
...
function productsInCategory(slug) {
	if (slug === "mode") return PRODUCTS.filter((p) => p.category === "mode" || p.category === "accessoires");
	if (slug === "maison") return PRODUCTS.filter((p) => p.category === "maison");
...
function similarProducts(product, limit = 4) {
...
//#endregion
export { productsInCategory as _, PRODUCT_REVIEWS as a, similarProducts as b, TESTIMONIALS as c, bestSellers as d, featuredProducts as f, newArrivals as g, getProductById as h, PRODUCTS as i, WHATSAPP_NUMBER as l, getProduct as m, FAQS as n, PROMO_CODES as o, getCategory as p, NAV_LINKS as r, SHIPPING_FEE as s, CATEGORIES as t, WHATSAPP_TEXT as u, promoProducts as v, searchProducts as y };
